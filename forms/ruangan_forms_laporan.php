...
session_start();
	...
	$query_d = mysqli_query($conn, "SELECT * from ruangan");
...
$content = "	
	...
	<div style='margin-top:40px'>	
		<h2 align='center'>Laporan Ruangan</h2>
		...
		<tbody align='' >
			...
			<tr>
    			...
    			<th style='width:100px;' valign='' align='center' >Kode Ruangan</th>
				<th style='width:100px;' valign='' align='center' >Nama Ruangan</th>
				<th style='width:100px;' valign='' align='center' >Jenis Ruangan</th>
				<th style='width:100px;' valign='' align='center' >Status</th>
   			</tr>
   		</tbody>";
...
$content .= "
	<tr>
		...
		<td align='center' valign='middle'>".$row['kode_ruangan']."</td>
		<td align='center' valign='middle'>".$row['nama_ruangan']."</td>
		<td align='center' valign='middle'>".$row['jenis_ruangan']."</td>
...
//echo $content;
    ...
    $html2pdf->Output('laporan_ruangan.pdf');
?>