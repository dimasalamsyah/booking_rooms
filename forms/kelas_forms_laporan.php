...
session_start();
	...
	$query_d = mysqli_query($conn, "SELECT * from kelas");
	...
	<div style='margin-top:40px'>	
		...
		<tbody align='' >
			...
			<tr>
				...
				<th style='width:100px;' valign='' align='center' >Nama Kelas</th>
				<th style='width:100px;' valign='' align='center' >Tinggkat</th>
				<th style='width:100px;' valign='' align='center' >Shift</th>
				<th style='width:200px;' align='center'>PA(Pembimbing Akademik)</th>
   			</tr>
   		</tbody>";
...
$content .= "
	<tr>
		...
		<td align='center' valign='middle'>".$row['nama_kelas']."</td>
		<td align='center' valign='middle'>".$row['tingkat']."</td>
		<td align='center' valign='middle'>".$row['shift']."</td>
		<td align='center' valign='middle'>".$row['pa']."</td>
	</tr>
	";
	$nourut++;
}
...
//echo $content;
    ...
    $html2pdf->Output('laporan_kelas.pdf');
?>