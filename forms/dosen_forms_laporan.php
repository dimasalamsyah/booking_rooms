...
session_start();
	...
	$query_d = mysqli_query($conn, "SELECT * from dosen");
...
$content = "	
	...
	<div style='margin-top:40px'>	
		<h2 align='center'>Laporan Dosen</h2>
		...
		<tbody align='' >
			...
			<tr>
    			...
    			<th style='width:100px;' valign='' align='center' >Kode Dosen</th>
				<th style='width:100px;' valign='' align='center' >Nama Dosen</th>
...
$content .= "
	<tr>
		...
		<td align='center' valign='middle'>".$row['kode_dosen']."</td>
		<td align='center' valign='middle'>".$row['nama_dosen']."</td>
