...
session_start();
	...
	$query_d = mysqli_query($conn, "SELECT * from mahasiswa");
...
$content = "	
	...
	<div style='margin-top:40px'>	
		<h2 align='center'>Laporan Mahasiswa</h2>
		...
		<tbody align='' >
			...
			<tr>
    			...
    			<th style='width:100px;' valign='' align='center' >NIM</th>
				<th style='width:100px;' valign='' align='center' >Nama Mahasiswa</th>
				<th style='width:100px;' valign='' align='center' >ID Kelas</th>
				<th style='width:100px;' valign='' align='center' >Jurusan</th>
				<th style='width:200px;' align='center'>No Tlp</th>
...
$content .= "
	<tr>
		...
		<td align='center' valign='middle'>".$row['nim']."</td>
		<td align='center' valign='middle'>".$row['nama']."</td>
		<td align='center' valign='middle'>".$row['id_kelas']."</td>
		<td align='center' valign='middle'>".$row['jurusan']."</td>
		<td align='center' valign='middle'>".$row['tlp']."</td>
