...
session_start();
	...
	$query_d = mysqli_query($conn, "SELECT * from jam");
...
$content = "	
	...
	<div style='margin-top:40px'>	
		<h2 align='center'>Laporan Jam</h2>
		...
		<tbody align='' >
			...
			<tr>
    			...
    			<th style='width:100px;' valign='' align='center' >Kode Jam</th>
				<th style='width:100px;' valign='' align='center' >Jam</th>
   			</tr>
   		</tbody>";
...
$content .= "
	<tr>
		...
		<td align='center' valign='middle'>".$row['kode_jam']."</td>
...
//echo $content;
    ...
    $html2pdf->Output('laporan_jam.pdf');
?>